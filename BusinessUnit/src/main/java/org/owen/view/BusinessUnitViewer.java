...
public class BusinessUnitViewer {
    ...
    public void run(SQLiteDataProvider sqLiteDataProvider) throws BusinessUnitExecutionException {
        while (true) {
            ...
            switch (choice) {
                case 1:
                    showWeatherMenu(sqLiteDataProvider);
                    break;
                case 2:
                    showHotelMenu(sqLiteDataProvider);
                    break;
                case 3:
    ...
    private void showWeatherMenu(SQLiteDataProvider sqLiteDataProvider) throws BusinessUnitExecutionException {
        System.out.println("---------------------");
        ...
        switch (islandNumber) {
            ...
            case 2:
                System.out.println();
                System.out.println("Showing the table:");
                List<List<String>> granCanaria = sqLiteDataProvider.getDataAsString("SELECT * FROM GranCanariaWeather", 0);
            ...
            case 3:
                System.out.println();
                System.out.println("Showing the table:");
                List<List<String>> lanzarote = sqLiteDataProvider.getDataAsString("SELECT * FROM LanzaroteWeather", 0);
            ...
            case 4:
                System.out.println("Showing the table:");
                List<List<String>> fuerteventura = sqLiteDataProvider.getDataAsString("SELECT * FROM FuerteventuraWeather", 0);
            ...
            case 5:
                System.out.println("Showing the table:");
                List<List<String>> laPalma = sqLiteDataProvider.getDataAsString("SELECT * FROM LaPalmaWeather", 0);
            ...
            case 6:
                System.out.println("Showing the table:");
                List<List<String>> elHierro = sqLiteDataProvider.getDataAsString("SELECT * FROM elHierroWeather", 0);
    ...
    private void showHotelMenu(SQLiteDataProvider sqLiteDataProvider) throws BusinessUnitExecutionException {
        System.out.println("---------------------");
        System.out.println("1. Tenerife");
        System.out.println("2. Gran Canaria");
        System.out.println("3. Lanzarote");
